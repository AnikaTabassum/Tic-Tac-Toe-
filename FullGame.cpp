...
void randomMove(char **board,legal_move *best_move)
{
    bool isValid=false;
     int randX ;
    int randY;
    ...
    best_move[0].hor=randX;
    best_move[0].vert= randY;
              ...
              if(GetAsyncKeyState(VK_LBUTTON))
              {
                  GetCursorPos(&c);
                       x=c.x; y=c.y;
                        ...
                        if(hor<3 && vert<3 && b[hor][vert]==false)
                        {
                             int X,Y;
...
int main()
{
  ...
  int gd = DETECT, gm;
    ...
    setcolor(2);
    rectangle(500,100,1050,200);
    outtextxy(725,130,"Start");


    setcolor(12);
    //rectangle(500,250,600,350);
    outtextxy(450,280,"Level");

    settextstyle(BOLD_FONT,HORIZ_DIR,2);

    setcolor(10);
    rectangle(650,250,750,350);
    outtextxy(670,300,"Easy");

    setcolor(14);
    rectangle(800,250,900,350);
    outtextxy(820,300,"Hard");

    settextstyle(BOLD_FONT,HORIZ_DIR,5);

    setcolor(12);
    //rectangle(500,400,600,500);
    outtextxy(450,430,"Move");

    settextstyle(BOLD_FONT,HORIZ_DIR,2);

    setcolor(14);
    rectangle(650,400,750,500);
    outtextxy(665,450,"Player");

    setcolor(10);
    rectangle(800,400,900,500);
    outtextxy(803,450,"Computer");


    setcolor(9);
    rectangle(950,400,1050,500);
    outtextxy(960,450,"1 vs 1");
    ...
    setcolor(4);
    rectangle(500,550,1050,650);
    outtextxy(725,580,"Exit");
    ...
    while(1)
    {
        ...
        if(GetAsyncKeyState(VK_LBUTTON))
        {
                ...
                if(x>499 && x<901 && y>99 && y<199)
                {
                    closegraph();
                    game(level,player);
                }
                else if(x>649 && x<751 && y>249 && y<351)
                {
                    level=0;

                }
                else if(x>799 && x<901 && y>249 && y<351)
                {
                    level=1;
                }
                else if(x>649 && x<751 && y>399 && y<501)
                {
                    player=0;

                }
                else if(x>799 && x<901 && y>399 && y<501)
                {

                    player=1;
                }
                else if(x>949 && x<1051 && y>399 && y<501)
                {
                     closegraph();
                     vs1();

                }
                else if(x>499 && x<901 && y>549 && y<651)
                {
                    closegraph();
                }
            }
